...
export const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium transition-all duration-200 ease-out hover:scale-105 active:scale-95 will-change-transform focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-default",
  {
    variants: {
      variant: {
        default:
        ...
        secondary: "border-transparent bg-muted text-foreground  hover:shadow-sm",
        destructive:
